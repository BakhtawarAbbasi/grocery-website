...
export default function CheckoutPage() {
  ...
  const sendOrderToBackend = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        const errText = await res.text();
        console.error('Failed to save order:', res.status, res.statusText || errText);
         console.log('Backend response status:', res.status);
      } else {
        console.log('Order saved successfully');
      }
    ...
    <div className="min-h-screen px-4 py-12 bg-gradient-to-br from-gray-50 to-gray-100">
         ...
         <div className="flex flex-col gap-8 p-8 bg-white shadow-lg rounded-xl md:flex-row">
           ...
           <div className="flex-1 p-6 border border-indigo-100 bg-indigo-50 rounded-xl">
            <div className="flex items-center justify-between mb-6">
             ...
             <div className="w-16 h-16 overflow-hidden rounded-lg">
               <Image src="/images/gharkasaamancrrop1.png" alt="Logo" className="object-cover w-full h-full" />
             </div>
           </div>
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px' }}>
          ...
          <Image src="/images/gharkasaamancrrop1.png" alt="Logo" style={{ width: '100px', height: 'auto' }} />
        </div>
