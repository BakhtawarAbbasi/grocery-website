...
//   const accountNumber = '0123456789'; // Added account number as a constant
...
//                   <input
//                     className={`w-full px-4 py-3 rounded-lg border ${errors.lastName ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500`}
//                     placeholder="Doe"
//                     value={lastName}
...
//                   </div>
//                   <p className="font-semibold text-indigo-600">Rs.{(item.price * item.quantity).toFixed(2)}</p>
//                 </div>
//               ))}
//             </div>
...
//       {/* Printable Invoice (without email and phone) */}
//       <div
//         id="invoice"
//         style={{
//           visibility: 'hidden',
...
//           <div>
//             <h1 style={{ fontSize: '24px', fontWeight: 'bold', marginBottom: '5px' }}>Order Invoice</h1>
...
//         <h3 style={{ fontSize: '18px', fontWeight: 'bold', margin: '20px 0' }}>Order Details</h3>
...
//                 <td style={{ padding: '10px', textAlign: 'right', borderBottom: '1px solid #eee' }}>{item.quantity}</td>
//                 <td style={{ padding: '10px', textAlign: 'right', borderBottom: '1px solid #eee' }}>Rs.{item.price.toFixed(2)}</td>
//                 <td style={{ padding: '10px', textAlign: 'right', borderBottom: '1px solid #eee' }}>Rs.{(item.price * item.quantity).toFixed(2)}</td>
//               </tr>
//             ))}
//           </tbody>
//         </table>
...
//             <span>Rs.0.00</span>
//           </div>
//           <div style={{ display: 'flex', justifyContent: 'space-between', fontWeight: 'bold', fontSize: '16px', paddingTop: '10px', borderTop: '1px solid #ddd' }}>
//             <span>Total:</span>
//             <span>Rs.{total.toFixed(2)}</span>
//           </div>
//         </div>

//         <div style={{ clear: 'both', paddingTop: '50px', textAlign: 'center', marginTop: '50px', color: '#666' }}>
//           <p style={{ fontWeight: 'bold' }}>Thank you for shopping with us!</p>
//           <p>If you have any questions about your order, please contact our customer support.</p>
//         </div>
//       </div>

//       {/* Payment Modal with Copy Account No Button */}
//       {showModal && (
...
//               <p className="mt-2 text-gray-600">Your order slip has been downloaded</p>
...
//                   <p><span className="font-medium">Bank Transfer:</span> HBL Bank</p>
//                   <div className="flex items-center justify-between">
//                     <p><span className="font-medium">Account No:</span> {accountNumber}</p>
//                     <button
            ...
            <div className="text-center">
              ...
              <div className="flex justify-center gap-4 mt-6">
                <button
                  ...
                  }` px-6 py-2 text-white transition-colors duration-200 bg-indigo-600 rounded-lg  hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                  I've Paid Online
                </button>
                <button
                  ...
                  } px-6 py-2 text-indigo-600 transition-colors duration-200 bg-white border border-indigo-600 rounded-lg hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                  Pay on Delivery
                </button>
              </div>
